      ...
      <div className="flex items-center gap-1">
        ...
        <p className="text-sm text-[#292929] flex gap-1 items-center">
          ...
          <div className="flex gap-1">
            <p
              className={`${rating >= 9 ? 'text-[#292929]' : rating >= 5 ? 'text-[#ff7a00]' : 'text-[#ff2e00]'} 2xl:text-[0.8vw]`}>
              {rating}
            </p>
            <div className="flex text-xs 2xl:text-[0.8vw]">
              <p>(</p>
              <p>{review}</p>
            </div>
            <p className="text-xs 2xl:text-[0.8vw]">Reviews)</p>
          </div>
        </p>
      </div>
      <div className="flex items-center gap-1">
