    ...
    <div className="flex flex-col sm:flex-row gap-y-5 justify-between w-full items-center">
      <div className="flex justify-between items-center w-full basis-4/5">
        <div className="flex flex-col gap-y-3 basis-1/2">
          <p className="text-[12px] sm:text-sm lg:text-base font-semibold c-chromaphobicblackhalf text-nowrap">
            Premier Smoking Room Only
          </p>
          <p className="text-[14px] sm:text-[16px] lg:text-[20px] c-chromaphobicblack">
            Without Breakfast
          </p>
          <p className="text-[12px] sm:text-sm lg:text-base text-nowrap text-[#57ab8e] font-semibold">
            Free Cancellation before 7 Aug 2024, 13:59
          </p>
          <p className="text-[12px] sm:text-sm lg:text-base font-semibold c-chromaphobicblackhalf">
      ...
      <div className="w-full sm:w-auto basis-1/5 flex justify-center items-center">
        <button className="w-full sm:w-auto text-[12px] sm:text-sm lg:text-base text-white font-semibold bg-eerieblack rounded-[3px] sm:rounded-[6px] px-5 lg:px-[22px] sm:py-[6px] lg:py-[7px]">
          Choose
        </button>
      </div>
    </div>
