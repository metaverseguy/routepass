              ...
              <div className="gap-4 flex justify-center items-center">
                <div>
                  ...
                  <label
                    ...
                    className={`ml-2 text-white ${
                      selectedTravelType.name === 'Return' ? 'text-white' : 'text-[#ffffff50]'
                    }`}>
                    Return
                  </label>
                </div>
                <div>
                  <input
                    ...
                    name="trip"
                    value="one-way"
                    onClick={() => setSelectedTravelType({ name: 'One Way', code: 'rt' })}
                  />
                  <label
                    htmlFor="one-way"
                    className={`ml-2 text-white ${
                      selectedTravelType.name === 'One Way' ? 'text-white' : 'text-[#ffffff50]'
                    }`}>
                    One Way
                  </label>
                </div>
                <div>
                  <input
                    ...
                    name="trip"
                    value="multi-city"
                    onClick={() => setSelectedTravelType({ name: 'Multi-City', code: 'rt' })}
                  />
                  <label
                    htmlFor="multi-city"
                    className={`ml-2 text-white ${
                      selectedTravelType.name === 'Multi-City' ? 'text-white' : 'text-[#ffffff50]'
                    }`}>
                    Multi-City
                  </label>
                </div>
