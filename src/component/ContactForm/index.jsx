      ...
      <div className="max-w-[1440px] w-full flex flex-col justify-center my-[80px] sm:my-[100px] mx-[20px] sm:mx-[60px] lg:mx-[130px]">
        <div className="flex flex-col gap-y-10">
          <div className="flex flex-col justify-center">
            <h2 className="text-[14px] sm:text-[18px] 2xl:text-[1vw] max:text-[24px] text-center">
              Lets Get in Touch
            </h2>
          ...
          <div className="bg-white rounded-[20px] p-5  sm:p-10 flex flex-col lg:flex-row gap-10 w-full justify-stretch content-stretch">
            <div className="relative bg-eerieblack text-white p-10 rounded-lg w-full lg:w-[40%] overflow-hidden">
              <div className="flex flex-col gap-y-[10px] mb-[120px] sm:mb-[160px]">
                <h4 className="text-[22px] sm:text-[28px] 2xl:text-[1.4vw] max:text-[32px] font-semibold">
                  Contact Information
                </h4>
                <p className="text-[13px] sm:text-base 2xl:text-[1vw] max:text-[24px]">
                  Say something to start a live chat!
                </p>
              </div>

              <div className="flex flex-col gap-y-5 mb:[60x] sm:mb-[150px]">
                <p className="flex gap-2 items-center text-[13px] sm:text-base 2xl:text-[1vw] max:text-[24px]">
            ...
            <form className="flex flex-col flex-1 justify-between">
              <div className="flex flex-col gap-y-10">
                <div className="flex flex-col sm:flex-row gap-9">
                  <div className="flex-1">
                    <p className="c-chromaphobicblack text-[11px] sm:text-xs 2xl:text-[0.9vw] max:text-[22px] font-semibold py-1">
                      First Name
                    </p>
                    <input
                      type="text"
                      placeholder="First Name"
                      className="w-full py-[7px] border-b outline-none focus:border-black text-[11px] sm:text-xs 2xl:text-[0.9vw] max:text-[22px]"
                      required
                    />
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex flex-col gap-y-[15px]">
                  <p className="font-semibold text-[11px] sm:text-sm 2xl:text-[1vw] max:text-[24px]">
                    Select Subject?
                  </p>
                  <div className="flex flex-wrap justify-between gap-3">
                    <div className="flex items-center gap-[10px] text-[9px] sm:text-[12px]">
                      ...
                      <p className="2xl:text-[0.9vw] max:text-[22px]">General Inquiry</p>
                    </div>
                ...
                <div className="flex flex-col gap-y-2">
                  <p className="c-chromaphobicblack font-semibold text-[11px] sm:text-xs 2xl:text-[0.9vw] max:text-[22px]">
                    Your Message
                  </p>
                  <input
                    type="text"
              ...
              <button className="bg-eerieblack text-white text-base sm:text-[20px] 2xl:text-[1.1vw] max:text-[26px] font-semibold py-[13px] sm:py-4 rounded-[8px] sm:rounded-[10px]">
                Send Message
              </button>
            </form>
          </div>
