    ...
    <div
      ...
      <FilterAccordion title="Times">
        <div className="py-5 border-b border-[#29292950] flex flex-col gap-y-5">
          <div className="bg-[#f5f5f5] rounded-[10px] p-[10px] gap-x-[10px] flex">
            <button
              className={`w-full  rounded-[8px] 2xl:text-[0.9vw] max:text-[22px] py-[10px] font-semibold ${timesValue === 'take-off' ? 'bg-[#1e1e1e] text-white' : 'bg-[#ffffff] text-[#29292950]'}`}
              onClick={() => setTimesValue('take-off')}>
              Take-off
            </button>
            <button
              className={`w-full rounded-[8px] py-[10px] 2xl:text-[0.9vw] max:text-[22px] font-semibold ${timesValue === 'take-off' ? 'bg-[#ffffff] text-[#29292950]' : 'bg-[#1e1e1e] text-white'}`}
          ...
          <div className="flex flex-col gap-y-[15px]">
            <div className="flex flex-col gap-y-2">
              <p className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#292929]">
                Take-off from (DPS)
              </p>
              <p className="text-xs 2xl:text-[0.8vw] max:text-[20px] text-[#29292950]">
                Mon 02:00 - Mon 10:00
              </p>
            </div>
            <div>
      ...
      <FilterAccordion title="Duration">
        <div className="py-5 border-b border-[#29292950] flex flex-col gap-y-[15px]">
          <div className="flex flex-col gap-y-2">
            <p className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#292929]">Flight Leg</p>
            <p className="text-xs 2xl:text-[0.8vw] max:text-[20px] text-[#29292950]">
              Mon 02:00 - Mon 10:00
            </p>
          </div>
      ...
      <FilterAccordion title="Price">
        <div className="py-5 flex flex-col gap-y-[15px] border-b border-[#29292950]">
          <p className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#292929]">$200 - $1800</p>
          <div>
            <MultiRangeSlider min={0} max={1000} />
          </div>
        </div>
      ...
      <FilterAccordion title="Airlines">
        <div className="flex pt-[10px]">
          <button className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#1e1e1e]">
            Select All
          </button>
          <div className="border-r boder-[#292929] mx-[10px]" />
          <button className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#1e1e1e50]">
            Clear All
          </button>
        </div>
      ...
      <FilterAccordion title="Airports">
        <div className="py-[20px] border-b border-[#29292950] flex flex-col gap-y-2">
          ...
          <p className="text-base 2xl:text-[0.9vw] max:text-[22px] font-semibold py-[15px]">Bali</p>

          <StopCheckBox stop="(DPS): I Gusti Ngurah Rai" price="$280" />
          <StopCheckBox stop="Example" price="$280" />

          <p className="text-base 2xl:text-[0.9vw] max:text-[22px] font-semibold py-[15px]">
            London
          </p>
      ...
      <FilterAccordion title="Booking Sites">
        ...
        <p className="text-sm 2xl:text-[0.9vw] max:text-[22px] text-[#1e1e1e]">Show 3 more</p>
      </FilterAccordion>
    </div>
  );
};
